...
```{r , echo=FALSE,dev='png"}
knitr::include_graphics('img/ch1/CS_homepage.png')
```
...
Also, it is always useful and recommended to use short variable names with English characters only. (for more: https://doc.cogstat.org/Handling-data)
...
If you would like to get more information on how to report a bug visit the following link: https://doc.cogstat.org/Report-a-bug)

```{r , echo=FALSE,dev='png"}
knitr::include_graphics('img/ch1/preferences.png'}
```

```{r , echo=FALSE,dev='png"}
knitr::include_graphics('img/ch1/detailederror.png'}
```
...
```{r , echo=FALSE,dev='png"}
knitr::include_graphics('img/ch1/explorevariable1.png'}
```

```{r , echo=FALSE,dev='png"}
knitr::include_graphics('img/ch1/explorevariable2.png'}
```
...
```{r , echo=FALSE,dev='png"}
knitr::include_graphics('img/ch1/explorevariables.png'}
```
...
```{r , echo=FALSE,dev='png"}
knitr::include_graphics('img/ch1/exp.graph1.png'}
```

```{r , echo=FALSE,dev='png"}
knitr::include_graphics('img/ch1/exp.des..png'}
```
...
```{r , echo=FALSE,dev='png"}
knitr::include_graphics('img/ch1/expvar_rawdata_cases.png'}
```

```{r , echo=FALSE,dev='png"}
knitr::include_graphics('img/ch1/expvar_hitogr(category).png'}
```

```{r , echo=FALSE,dev='png"}
knitr::include_graphics('img/ch1/expvar_sampleprop(cat).png'}
```
...
### What are the subcategories of films?
...
```{r , echo=FALSE,dev='png"}
knitr::include_graphics('img/ch1/expvar_histogram(subcategory).png'}
```
...
```{r , echo=FALSE,dev='png"}
knitr::include_graphics('img/ch1/Expvar_sampleprop(subcategory).png'}
```
...
```{r , echo=FALSE,dev='png"}
knitr::include_graphics('img/ch1/comparegroups.png'}
```

```{r , echo=FALSE,dev='png"}
knitr::include_graphics('img/ch1/comparegroups2.png'}
```
...
```{r , echo=FALSE,dev='png"}
knitr::include_graphics('img/ch1/compraw.png'}
```
...
```{r , echo=FALSE,dev='png"}
knitr::include_graphics('img/ch1/compare_mpsaic.png'}
```
...
```{r , echo=FALSE,dev='png"}
knitr::include_graphics('img/ch1/comparecont.png'}
```
...
```{r , echo=FALSE,dev='png"}
knitr::include_graphics('img/ch1/preferences2.png'}
```

```{r , echo=FALSE,dev='png"}
knitr::include_graphics('img/ch1/preferences_charttheme.png'}
```
...
```{r , echo=FALSE,dev='png"}
knitr::include_graphics('img/ch1/lieexhisto.png'}
```
...
```{r , echo=FALSE,dev='png"}
knitr::include_graphics('img/ch1/variablepair1.png'}
```

or

```{r , echo=FALSE,dev='png"}
knitr::include_graphics('img/ch1/variablepair2.png'}
```
...
```{r , echo=FALSE,dev='png"}
knitr::include_graphics('img/ch1/variablepairplot.png'}
```
...
```{r , echo=FALSE,dev='png"}
knitr::include_graphics('img/ch1/menu_clearresults.png'}
```
...
(for more: https://doc.cogstat.org/Handling-output)
...
```{r , echo=FALSE,dev='png"}
knitr::include_graphics('img/ch1/feature.png'}
```
...
```{r , echo=FALSE,dev='png"}
knitr::include_graphics('img/ch1/menu_reportaproblem.png'}
```
